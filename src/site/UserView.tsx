...
const styles = (theme: Theme) =>
  createStyles({
    ...
    skillCard: {
      ...
      background: "linear-gradient(90deg, rgba(44, 44, 44, 0.81) 0%, rgba(44, 44, 44, 0.962647) 80.34%, #2C2C2C 100%)",
      borderRadius: "1.75rem",
    },
    header: {
    ...
    return (
      <React.Fragment>
        ...
        <Container maxWidth="sm" className={classes.root}>
          ...
          <ResourcesView userToken={this.props.userToken} baseURL={this.props.baseURL} activeTagId={this.state.activeTagId} />
        </Container>
        {this.state.editOpen ? <EditSkill userToken={this.props.userToken}
  baseURL={this.props.baseURL} getSkills={this.getSkills} skillToEditName={this.state.activeTagName} skillToEditId={this.state.activeSkillId} skillToEditBoolean={this.state.activeSkillBoolean} handleEditClick={this.handleEditClick} editOpen={this.state.editOpen} /> : null }
      </React.Fragment>
    );
  }
}
